...
export async function GET(request: NextRequest) {
  try {
    ...
    await Promise.all([
      userRef.collection('levelProgress').doc('level1').set(progressPayload.level1, { merge: true }),
      userRef.collection('levelProgress').doc('level2').set(progressPayload.level2, { merge: true }),
      userRef.collection('levelProgress').doc('level3').set(progressPayload.level3, { merge: true }),
      userRef.collection('levelProgress').doc('level4').set(progressPayload.level4, { merge: true }),
    ])
