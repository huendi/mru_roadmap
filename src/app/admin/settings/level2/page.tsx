...
export default function AdminSettingsLevel2Page() {
  return (
    <div className="flex flex-col h-full overflow-hidden">
      {/* Page header */}
      <div className="px-4 sm:px-6 pt-6 pb-4 flex-shrink-0">
        <h2 className="text-lg font-bold text-gray-900">Settings - Level 2</h2>
        <p className="text-sm text-gray-500 mt-0.5">Configure content for Level 2: SLTC Training</p>
      </div>
