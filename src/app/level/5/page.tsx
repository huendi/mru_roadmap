      ...
      <main className="w-[90%] mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-xl shadow-lg p-8">
            <div className="text-center">
              <h1 className="text-3xl font-bold text-gray-900 mb-4">Level 5 – Pay & Take Licensure Exam</h1>
              ...
              <div className="bg-gray-100 rounded-lg p-6 mb-6">
                ...
                <ul className="text-left text-gray-600 space-y-2 max-w-md mx-auto">
                  <li>• Schedule your IC or IIAP licensure exam</li>
                  <li>• Pay examination fees</li>
                  <li>• Complete licensure requirements</li>
                  <li>• Submit proof of exam completion</li>
                </ul>
              </div>
